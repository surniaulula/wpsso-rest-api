...
WPSSO Core add-on to provide arrays of meta tag and Schema markup in the WordPress REST API post, term and user queries.

== Description ==

<p style="margin:0;"><img class="readme-icon" src="https://surniaulula.github.io/wpsso-rest-api/assets/icon-256x256.png"></p>

<p>The WPSSO REST API add-on includes a "head" element in the WordPress REST API query, which offers an "html" array and "parts" array.</p>

<p>The "html" array includes the HTML formatted meta tags and Schema JSON-LD (aka LD+JSON) scripts, as they appear in the webpage head section.</p>

<p>The "parts" array provides the elements of each HTML meta tag, making it easier and faster to extract the content of any meta tag.</p>
