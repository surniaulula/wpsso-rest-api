...
<p>The WPSSO REST API add-on includes a "head" array element in the WordPress REST API query, which offers an "html" array and "parts" array. The "html" array includes the HTML formatted meta tags and Schema JSON-LD (aka LD+JSON) scripts, as they appear in the webpage head section. The "parts" array provides the elements of each HTML meta tag, making it easier and faster to extract the content of any meta tag.</p>
