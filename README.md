...
<li><p>The <code>json</code> array provided any Schema JSON-LD (aka LD+JSON) scripts in their decoded format.</p></li>
<li><p>The <code>parts</code> array offers HTML meta tag attributes (aka "the parts") as individual arrays, making it easier and faster to use specific meta tags.</p></li>
</ul>
