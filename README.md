<h1>WPSSO REST API</h1><h3>Advanced Meta Tags and Schema Markup in Post, Term, and User REST API Queries</h3>
...
<p>The <code>json</code> array provided any Schema JSON-LD (aka LD+JSON) scripts in their decoded format.</p>

<p>The <code>parts</code> array offers HTML meta tag attributes (aka "the parts") as individual arrays, making it easier and faster to use specific meta tags.</p>

<p>There are no plugin settings &mdash; simply <em>download</em>, <em>install</em>, and <em>activate</em>.</p>

<h3>WPSSO Core Plugin Prerequisite</h3>

<p>WPSSO REST API (aka WPSSO REST) is an add-on for the WPSSO Core plugin (Free or Pro version).</p>

<p>The WPSSO Schema JSON-LD Markup add-on (Free or Pro version) is recommended to get complete meta tags and Schema JSON-LD markup for posts, pages, terms, users, etc.</p>
